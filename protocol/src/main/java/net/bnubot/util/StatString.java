 ...
 * $Id: StatString.java 1856 2009-07-24 18:07:21Z scotta $
 */
...
public class StatString {
	private static final String[] D2Classes = { "Amazon", "Sorceress",
	...
	public StatString(String statString) {
		...
		try {
			...
			Out.error(StatString.class,
					"Error parsing statstring: " + e.getMessage() + "\n"
	...
	public String getIconName(ProductIDs product, int icon) {
		...
		case WAR3:
			...
			case IconIDs.ICON_W3R1:
				return "Orc Peon";
			case IconIDs.ICON_W3H2:
				return "Human Footman";
			case IconIDs.ICON_W3H3:
				return "Human Knight";
			case IconIDs.ICON_W3H4:
				return "Human Archmage";
			case IconIDs.ICON_W3H5:
				return "Human Midvh";
			case IconIDs.ICON_W3O2:
				return "Orc Grunt";
			case IconIDs.ICON_W3O3:
				return "Orc Tauren";
			case IconIDs.ICON_W3O4:
				return "Orc Far Seer";
			case IconIDs.ICON_W3O5:
				return "Orc Thrall";
			case IconIDs.ICON_W3N2:
				return "Night Elf Archer";
			case IconIDs.ICON_W3N3:
				return "Night Elf Druid of the Claw";
			case IconIDs.ICON_W3N4:
				return "Night Elf Priestess of the Moon";
			case IconIDs.ICON_W3N5:
				return "Night Elf Furion Stormrage";
			case IconIDs.ICON_W3U2:
				return "Undead Ghoul";
			case IconIDs.ICON_W3U3:
				return "Undead Abomination";
			case IconIDs.ICON_W3U4:
				return "Undead Lich";
			case IconIDs.ICON_W3U5:
				return "Undead Tichondrius";
			case IconIDs.ICON_W3R2:
				return "Green Dragon Whelp";
			case IconIDs.ICON_W3R3:
				return "Blue Dragon";
			case IconIDs.ICON_W3R4:
				return "Red Dragon";
			case IconIDs.ICON_W3R5:
				return "Deathwing";
			}
			break;
		...
		case W3XP:
			...
			case IconIDs.ICON_W3U1:
			case IconIDs.ICON_W3R1:
			case IconIDs.ICON_W3D1:
				return "Orc Peon";
			case IconIDs.ICON_W3H2:
				return "Human Rifleman";
			case IconIDs.ICON_W3H3:
				return "Human Sorceress";
			case IconIDs.ICON_W3H4:
				return "Human Spellbreaker";
			case IconIDs.ICON_W3H5:
				return "Human Blood Mage";
			case IconIDs.ICON_W3H6:
				return "Human Jaina";
			case IconIDs.ICON_W3O2:
				return "Orc Troll Headhunter";
			case IconIDs.ICON_W3O3:
				return "Orc Shaman";
			case IconIDs.ICON_W3O4:
				return "Orc Spirit Walker";
			case IconIDs.ICON_W3O5:
				return "Orc Shadow Hunter";
			case IconIDs.ICON_W3O6:
				return "Orc Rexxar";
			case IconIDs.ICON_W3N2:
				return "Night Elf Huntress";
			case IconIDs.ICON_W3N3:
				return "Night Elf Druid of the Talon";
			case IconIDs.ICON_W3N4:
				return "Night Elf Dryad";
			case IconIDs.ICON_W3N5:
				return "Night Elf Keeper of the Grove";
			case IconIDs.ICON_W3N6:
				return "Night Elf Maiev";
			case IconIDs.ICON_W3U2:
				return "Undead Crypt Fiend";
			case IconIDs.ICON_W3U3:
				return "Undead Banshee";
			case IconIDs.ICON_W3U4:
				return "Undead Destroyer";
			case IconIDs.ICON_W3U5:
				return "Undead Crypt Lord";
			case IconIDs.ICON_W3U6:
				return "Undead Sylvanas";
			case IconIDs.ICON_W3R2:
				return "Myrmidon";
			case IconIDs.ICON_W3R3:
				return "Siren";
			...
			case IconIDs.ICON_W3R5:
				return "Sea Witch";
			case IconIDs.ICON_W3R6:
				return "Illidan";
			case IconIDs.ICON_W3D2:
				return "Felguard";
			case IconIDs.ICON_W3D3:
				return "Infernal";
			case IconIDs.ICON_W3D4:
				return "Doomguard";
			case IconIDs.ICON_W3D5:
				return "Pit Lord";
			case IconIDs.ICON_W3D6:
				return "Archimonde";
			}
			break;
		default:
	...
	public void parse() throws IOException {
		...
		if (is == null) {
			try {
				product = ProductIDs.fromDWord(HexDump
						.StringToDWord(statString[0]));
		...
		if ((is != null) || (statString.length > 1)
				|| (statString[0].length() > 4)) {
			switch (product) {
			case STAR:
			case SEXP:
			case JSTR:
			...
			case DRTL:
				 ...
				 * These products use the same format for their statstrings as
				 * Diablo. Most of these fields are usually 0 and their meanings
				 * are not known. 1 Ladder Rating The user's current ladder
				 * rating. 2 Ladder rank The player's rank on the ladder. 3 Wins
				 * The number of wins the user has in normal games. 4 Spawned
				 * This field is 1 if the user's client is spawned, 0 otherwise.
				 * 5 Unknown 6 High Ladder Rating This is the user's 'highest
				 * ever' ladder rating. 7 Unknown 8 Unknown 9 Icon This value
				 * should be matched against the product values of each icon in
				 * each Battle.net Icon file that is loaded. If a match is
				 * found, the client should use this icon when displaying the
				 * user.
				 */
				if (is != null) {
					if (is.readByte() == 0) // discard the space, or terminate
											// the
											// string
						break;
				...
				try {
					...
					if ((highLadderRating != 0)
							&& (highLadderRating != ladderRating))
						prettyEnd.append(", Ladder highest ever rating ")
								.append(highLadderRating);
					if (unknown7 != 0)
					...
					if ((icon != 0) && (icon != product.getDword()))
						prettyEnd.append(", ")
								.append(HexDump.DWordToPretty(icon))
								.append(" icon");
				} catch (Exception e) {
					Out.exception(e);
				}
			...
			case D2XP:
				...
				if (is == null) {
					...
					if (statString2.length != 3) {
						prettyEnd.append("unknown statstr2 len: ").append(
								statString2.length);
						break;
					}
				} else {
					...
					if (is.readByte() != 0)
						throw new IOException(
								"after read 33 bytes of data, no null found");
				}
				...
				if (expansion) {
					...
					case 0:
						break;
					case 1:
						prettyEnd.append(hardcore ? "Destroyer " : "Slayer ");
						break;
					case 2:
						prettyEnd.append(hardcore ? "Conquer " : "Champion ");
						break;
					case 3:
						prettyEnd.append(hardcore ? "Guardian "
								: (female ? "Matriarch " : "Patriarch "));
						break;
					default:
						prettyEnd.append("?d=").append(difficulty);
						break;
					}
				} else {
					switch (difficulty) {
					case 0:
						break;
					case 1:
						prettyEnd.append(female ? (hardcore ? "Countess "
								: "Dame ") : (hardcore ? "Count " : "Sir "));
						break;
					case 2:
						prettyEnd.append(female ? (hardcore ? "Duchess "
								: "Lady ") : (hardcore ? "Duke " : "Lord "));
						break;
					case 3:
						prettyEnd.append(female ? (hardcore ? "Queen "
								: "Baroness ")
								: (hardcore ? "King " : "Baron "));
						break;
					default:
				...
				if (difficulty < 3) {
					...
					switch (difficulty) {
					case 0:
						prettyEnd.append("Normal");
						break;
					case 1:
						prettyEnd.append("Nightmare");
						break;
					case 2:
						prettyEnd.append("Hell");
						break;
					default:
						prettyEnd.append("?");
						break;
			...
			case W3XP:
				...
				if (statString2.length >= 2) {
					...
					if (icon != 0)
						prettyEnd.append(", ")
								.append(getIconName(product, icon))
								.append(" icon");
					if (level != 0)
