...
public class TimeFormatter {
	...
	public static long parseDuration(String duration)
		...
		for (String part : duration.split(" ")) {
			...
			String unit = part.substring(i).toLowerCase(Locale.getDefault());
			switch (unit.charAt(0)) {
			case 's':
				if ("s".equals(unit) || "second".equals(unit)
						|| "seconds".equals(unit)) {
					out += base * SECOND;
					continue;
				}
			...
			case 'm':
				if ("m".equals(unit) || "min".equals(unit)
						|| "mins".equals(unit) || "minute".equals(unit)
						|| "minutes".equals(unit)) {
					out += base * MINUTE;
					continue;
				}
				break;
			case 'h':
				if ("h".equals(unit) || "hour".equals(unit)
						|| "hours".equals(unit)) {
					out += base * HOUR;
					continue;
				}
			...
			case 'd':
				...
				break;
			case 'w':
				if ("w".equals(unit) || "week".equals(unit)
						|| "weeks".equals(unit)) {
					out += base * WEEK;
					continue;
				}
