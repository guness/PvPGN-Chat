 ...
 *
 * $Id: Wildcard.java 1609 2008-09-12 17:58:03Z scotta $
 */
package net.bnubot.util;

/**
 * Compilation: javac Wildcard.java In.java Execution: java Wildcard pattern <
 * wordlist.txt
 * 
 * Find all lines in wordlist.txt that match the given pattern by simulating a
 * nondeterminstic finite state automaton using an Boolean array states[] which
 * records all states that the NFSA could be in after reading in a certain
 * number of characters.
 * 
 * Patterns supported ------------------------------ * any zero or more
 * characters . any one character *REMOVED* c character c
 * 
